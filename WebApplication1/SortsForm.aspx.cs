...
{
    public partial class SortsForm : System.Web.UI.Page
    {
        ...
        protected void sortsDataSource_Inserting(object sender, SqlDataSourceCommandEventArgs e)
        {
            TryPerformQuery(e);
        }

        protected void sortsDataSource_Updating(object sender, SqlDataSourceCommandEventArgs e)
        {
            TryPerformQuery(e);
        }
