...
{
    public partial class ProductsInShopsForm : System.Web.UI.Page
    {
        ...
        protected void ProductInShopDataSource_Inserting(object sender, SqlDataSourceCommandEventArgs e)
        {
            TryPerformQuery(e);
        }
        ...
        protected void ProductInShopDataSource_Updating(object sender, SqlDataSourceCommandEventArgs e)
        {
            TryPerformQuery(e);
        }
